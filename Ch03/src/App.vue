<template>
  ...
  <h4>2) Option API</h4>
  <ApiComponent1></ApiComponent1>
  <ApiComponent2></ApiComponent2>
  <ApiComponent3></ApiComponent3>
  <ApiComponent4></ApiComponent4>
  <hr/>

  <h4>3) 컴포넌트 통신</h4>
  <UComponent1 :name="name"></UComponent1>
  <UComponent1 :name="name" :age="age"></UComponent1>
  <ul>
    <UComponent2 v-for="city in cities" :city="city"></UComponent2>
  </ul>
  <ul>
    <UComponent2 :cities="cities"></UComponent2>
  </ul>
  <UComponent3 :c3Name="name" :c3Age="age"></UComponent3>
  <UComponent5 v-on:myShow="showMyData"></UComponent5>
  ...
  <h4>4) 컴포넌트 생명주기</h4>
  <NewComponent v-if="isShow"></NewComponent>
  <button @click="btnRemove">컴포넌트 {{ tit }}</button>
  <hr/>
 ...
 * 
 * 컴포넌트(Component)
 *  - 화면 구성요소를 독립적인 모듈형태로 구성하기 위한 SFC 구조체
...
import ApiComponent1 from './components/sub2/ApiComponent1.vue';
import ApiComponent2 from './components/sub2/ApiComponent2.vue';
import ApiComponent3 from './components/sub2/ApiComponent3.vue';
import ApiComponent4 from './components/sub2/ApiComponent4.vue';
